= Balance Sheet for FY {{cfg.fy}}
:company: {{cfg.company.name}}

== Balance Sheet as on 31 March {{cfg.fy+1}}

// https://cleartax.in/s/balance-sheet/
[options="header",cols="4,1,2,2"]
|===
| Particulars | Note No. | {{cfg.fy}}-{{cfg.fy+1}} | {{cfg.fy-1}}-{{cfg.fy}}

h| I. EQUITY AND LIABILITIES | | |
h| 1) Shareholder's Funds | | |
| (a) Share Capital | 1 | {{account.liabilities.share_capital}} | {{prev_account.liabilities.share_capital}}
| (b) Reserves and Surplus | | {{account.liabilities.surplus}} | {{prev_account.liabilities.surplus}}
| (c) Money received against share warrants | | |
h| (2) Share application money pending allotment | | |
h| (3) Non-Current Liabilities | | |
...
h| Total | | {{account.liabilities.total}} | {{prev_account.liabilities.total}}
h| II. Assets | | |
h| (1) Non-current assets | | {{account.assets.non_current}} | {{prev_account.assets.non_current}}
...
h| Total | | {{account.assets.total}} | {{prev_account.assets.total}}
|===

NOTE: Short-term provisions include TDS Liability and Auditor Fees.
